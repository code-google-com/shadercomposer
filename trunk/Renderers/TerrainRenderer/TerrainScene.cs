...
{
    class TerrainScene : ISlimDXScene
    {
        ...
        public TerrainScene(TerrainRenderer terrainRenderer)
        {
            ...
            // Create the teappot
            terrainObject = new TerrainObject(terrainRenderer, renderingDevice);

            // Create the camera
            camera = new ThirdPersonCamera(terrainObject);

        }

        public void SetSourceCode(string sourceCode)
        {
            terrainObject.SetSourceCode(sourceCode);
        }
        ...
        public void Render(int ellapsedTime)
        {
            ...
            renderingDevice.ImmediateContext.ClearRenderTargetView(renderTargetView, new Color4(1, 168, 181, 189));
            ...
            // Render the teapot
            terrainObject.Render(camera, ellapsedTime);
